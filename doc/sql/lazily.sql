...
-- 创建数据库
CREATE DATABASE IF NOT EXISTS `lazily` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
...
-- 插入初始管理员账号
INSERT INTO `sys_user` (`user_id`, `dept_id`, `username`, `nickname`, `password`, `status`, `create_time`, `remark`)
VALUES (1, 100, 'admin', '系统管理员', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', NOW(), '管理员账号');

-- 初始角色
INSERT INTO `sys_role` (`role_id`, `role_name`, `role_key`, `role_sort`, `status`, `create_time`)
VALUES (1, '超级管理员', 'admin', 1, '0', NOW());
...
VALUES (1, '系统管理', 0, 1, 'system', NULL, 'M', '0', '0', '', 'system', NOW());

-- 初始部门
INSERT INTO `sys_dept` (`dept_id`, `parent_id`, `ancestors`, `dept_name`, `order_num`, `status`, `create_time`)
VALUES (100, 0, '0', 'Lazily科技', 0, '0', NOW());
